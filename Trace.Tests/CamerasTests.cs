...
public class CamerasTests
{
    ...
    public void OrthoObserver()
    {
        ...
        var camera2 = new OrthogonalCamera(Transformation.Translation(-2.0f*Vec.YAxis)*Transformation.RotationZ(90), 2.0f);
    ...
    public void PerspObserver()
    {
        ...
        var r1 = camera1.FireRay(0.5f, 0.5f);
        var camera2 = new PerspectiveCamera(Transformation.Translation(-2.0f*Vec.YAxis)*Transformation.RotationZ(90), 2.0f);
        var r2 = camera2.FireRay(0.5f, 0.5f);
