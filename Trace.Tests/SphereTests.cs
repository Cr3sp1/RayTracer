...
public class SphereTests
{
    ...
    public void TestTransformations()
    {
        ...
        var exp1 = new HitRecord(new Point(10.0f, 0.0f, 1.0f), new Normal(0.0f, 0.0f, 1.0f), new Vec2D(0.0f, 0.0f), 1.0f,
            ray1);
        ...
        var exp2 = new HitRecord(new Point(11.0f, 0.0f, 0.0f), new Normal(1.0f, 0.0f, 0.0f), new Vec2D(0.0f, 0.5f), 2.0f,
            ray2);
